...
echo
echo -e "\033[34m*********************************************\e[0m"
echo -e "\033[32m***      WELCOME TO AUTODEPLOY TOOL       ***\e[0m"
echo -e "\033[34m*********************************************\e[0m"
...
sudo apt upgrade
echo
echo -e "\033[33msystem update & ugraded\e[0m"
echo -e $nextcmd
sleep 3s
#install python 
...
then
    ...
    echo
    echo -e "\033[33mpython3.7 installed\e[0m"
    echo -e $nextcmd
    sleep 3s
fi
...
then
    ...
    echo
    echo -e "\033[33mphp7.2  installed\e[0m" 
    echo -e $nextcmd
    sleep 3s
fi
...
then
    ...
    echo
    echo -e "\033[33mcomposer& laravel installer installed\e[0m"
    echo -e $nextcmd
    sleep 3s
fi
...
then
    ...
    echo -e "\033[33mnode & npm installed\e[0m"
    echo -e $nextcmd
    sleep 3s
fi
...
then
    ...
    echo
    echo -e "\033[33myarn installed\e[0m"
    echo -e $nextcmd
    sleep 3s
fi
# update apt
...
sleep 3s
#Final manuel setup
echo -e "\033[36mTODO: config php ini set: cgi.fix_pathinfo=0\e[0m"
echo -e "\033[36mTODO: set nginx root \e[0m"
echo -e "\033[36mapt packages installed\e[0m"
nginx -v
php -v
yarn -v
node -v
